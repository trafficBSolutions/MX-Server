...
const submitLogo = async (req, res) => {
    try {
        const {
            first,
            last,
        ...
        // Create user record
        const newUser = await LogoUser.create({
            first,
            last,
            company,
            email,
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    >LOGO REDESIGN REQUEST</h2>
                        ...
                        <h1 style="margin-top: 5px;
                            font-family: 'Moveo Sans w00 Regular', Arial, Helvetica, sans-serif;"
                            >Your Logo Redesign submission has been received successfully! We will be with you within 48 hours!</h1>
                        ...
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        line-height: 26px;
                        ">At MX, we greatly value your business. We wanted to inform you that your LOGO REDESIGN request has been successfully submitted. Thank you for taking proactive steps to ensure your logo is
