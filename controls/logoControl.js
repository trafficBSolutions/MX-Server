        ...
        const mailOptions = {
            ...
            <html lang="en">
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    <h2>LOGO REDESIGN REQUEST</h2>
                            <div style="margin-bottom: 15px;">
                        <p>Hi <strong>${name}</strong>,</p>
                        <p>Your Logo Redesign submission has been received successfully!
                            If you have any questions or concerns regarding your logo, please call (706) 581-4465.
                            </p>
                        <h3>Contact Info:</h3>
