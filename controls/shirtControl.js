...
const submitApparel = async (req, res) => {
    ...
    list-style: none;>
                        <p><strong>Apparel Type:</strong> ${apparel.type}</p>
                        <p><strong>Apparel Size:</strong> ${apparel.size}</p>
                        <p><strong>Apparel Color:</strong> ${apparel.color}</p>
                        <p><strong>Apparel Quantity:</strong> ${apparel.quantity}</p>
                    </li>
                `;
            });
            apparelsHtml += `</ul>`;
        ...
        const mailOptions = {
            ...
            <html lang="en">
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    <h2>CUSTOMIZABLE APPAREL REQUEST</h2>
                            <div style="margin-bottom: 15px;">
                        <p>Hi <strong>${name}</strong>,</p>
                        <p>Your Apparel Submission has been received successfully! 
                            If you have any questions or concerns regarding your apparel, please call (706) 263-0175.
                            </p>
                        <h3>Contact Info:</h3>
