...
const submitApparel = async (req, res) => {
    try {
        ...
        const apparels = JSON.parse(req.body.apparels); // Parse the apparel array from the request body
        ...
        // Create user record
        const newUser = await ApparelUser.create({
            first,
            last,
            company,
            email,
        ...
        if (apparels.length > 0) {
            apparels.forEach((apparel, index) => {
                apparelsHtml += `
    ...
    list-style: none;>
                        ...
                        "><b>Apparel Type:</b> ${apparel.type}</p>
                        <p style="
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        font-style: normal;
                        margin-top: 20px;
                        ...
                        font-size: 30px;
                        font-family: Arial, Helvetica, sans-serif;
                        "><b>Apparel Size:</b> ${apparel.size}</p>
                        ...
                        font-size: 30px;
                        font-family: Arial, Helvetica, sans-serif;
                        "><b>Apparel Color:</b> ${apparel.color}</p>
                        ...
                        font-size: 30px;
                        font-family: Arial, Helvetica, sans-serif;
                        "><b>Apparel Quantity:</b> ${apparel.quantity}</p>
                    </li>
                `;
            });
            apparelsHtml += `</ul>`;
        } else {
            apparelsHtml = '<p>No apparel submitted.</p>';
        }

        // Compose email options with the apparel included
        const mailOptions = {
            ...
            <html lang="en">
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                    color:#000000;"
                    >CUSTOMIZABLE APPAREL REQUEST</h2>
                        ...
                        <h1 style="margin-top: 5px;
                            font-family: 'Moveo Sans w00 Regular', Arial, Helvetica, sans-serif;"
                            >Your Apparel Submission has been received successfully! We will be with you within 48 hours!</h1>
                        ...
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        line-height: 26px;
                        ">At MX, we greatly value your business. We wanted to inform you that your Custom Apparel request has been successfully submitted. Thank you for taking proactive steps to ensure that your business is well-represented.
        ...
        const response = {
            message: 'Custom Apparel submitted successfully',
        ...
        console.error('Error submitting Custom Apparel:', error);
