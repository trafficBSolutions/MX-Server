                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    >BANNER REQUEST</h2>
                        ...
                        <h1 style="margin-top: 5px;
                            font-family: 'Moveo Sans w00 Regular', Arial, Helvetica, sans-serif;"
                            >Your Banner submission has been received successfully! We will be with you within 48 hours!</h1>
                        ...
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        line-height: 26px;
                        ">At MX, we greatly value your business. We wanted to inform you that your BANNER request has been successfully submitted. Thank you for taking proactive steps to ensure your places are
                        can stand out and effectively communicate your brand messages for you or for your businesses and organizations.
