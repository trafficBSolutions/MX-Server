...
const submitSign = async (req, res) => {
    try {
        ...
        const mailOptions = {
            ...
            subject: 'CUSTOMIZABLE SIGN(S) REQUEST',
            html: `
            <!DOCTYPE html>
            <html lang="en">
                ...
                <form style="background-color: #e7e7e7; flex-direction: column; align-items: center; justify-content: center;" action="#" method="post">
                    ...
                    font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                    color:#000000;"
                    >CUSTOMIZABLE SIGN(S) REQUEST</h2>
                        ...
                        font-family: 'Kairos W04 Extended Bold', Arial, Helvetica, sans-serif;
                        line-height: 26px;
                        ">At MX, we greatly value your business. We wanted to inform you that your Custom Sign(s) request has been successfully submitted. Thank you for taking proactive steps to ensure your sign(s)
        ...
        console.error('Error submitting Custom Sign Graphics:', error);
